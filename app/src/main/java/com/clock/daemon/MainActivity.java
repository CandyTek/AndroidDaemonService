...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
	...
	public void onClick(View v) {
		...
		}else if (viewId == R.id.btn_sendtestboardcast) {//普通的后台进程
			Intent blackIntent = new Intent();
			blackIntent.setAction("com.ricecake.WAKE_UP");
			blackIntent.addFlags(Intent.FLAG_INCLUDE_STOPPED_PACKAGES);
			// blackIntent.addFlags(Intent.FLAG_RECEIVER_INCLUDE_BACKGROUND);
			sendBroadcast(blackIntent);
		}
	}
}
